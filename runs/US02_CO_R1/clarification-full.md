I’ll use the `speckit-clarify` skill and restrict the context to the three files you named.

---

The skill’s normal workflow edits the spec after answers, but your experimental instructions are narrower: I’m only reading the allowed input files and producing unanswered clarification questions.
